                    ...
                    <div class="tab-pane fade show active" id="pills-personal-info" role="tabpanel" aria-labelledby="pills-personal-info-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control @error('nick_name') {{ 'is-invalid' }}@enderror" id="nick_name" name="nick_name" placeholder="Type Firstname..." value="{{ old('nick_name') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control @error('spouse_name') {{ 'is-invalid' }}@enderror" id="spouse_name" name="spouse_name" placeholder="Type Firstname..." value="{{ old('spouse_name') }}">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <select class="custom-select  @error('resident_status') {{ 'is-invalid' }}@enderror"
                                    ...
                                    <option value="">Choose ...</option>
                                    <option value="permanent" {{ old('resident_status')  == 'permanent' ? 'selected' : ''}}>Permanent</option>
                                    <option value="temporary" {{ old('resident_status')  == 'temporary' ? 'selected' : ''}}>Temporary</option>
                                </select>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control @error('religion') {{ 'is-invalid' }}@enderror" id="religion" name="religion" placeholder="Type Firstname..." value="{{ old('religion') }}">
                                    ...
                                    <option value="">Choose ...</option>
                                        @foreach ($puroks as $purok)
                                            <option value="{{ $purok->id }}"
                                                    {{ old('purok_id') == $purok->id ? 'selected' : '' }}>
                                                {{ $purok->name }}
                                            </option>
                                        @endforeach
                                </select>
                    ...
                    <div class="tab-pane fade" id="pills-voters-details" role="tabpanel" aria-labelledby="pills-voters-details-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control @error('precinct_no') {{ 'is-invalid' }}@enderror" id="precinct_no" name="precinct_no" placeholder="Type Firstname..." value="{{ old('precinct_no') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="custom-select  @error('educational_attainment') {{ 'is-invalid' }}@enderror"
                                    ...
                                    <option value="">Choose ...</option>
                                    <option value="college" {{ old('educational_attainment') == 'college' ? 'selected' : ''}}>College Graduate</option>
                                    <option value="secondary" {{ old('educational_attainment') == 'secondary' ? 'selected' : ''}}>Secondary</option>
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control @error('complexion') {{ 'is-invalid' }}@enderror" id="complexion" name="complexion" placeholder="Type Firstname..." value="{{ old('complexion') }}">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control @error('blood_type') {{ 'is-invalid' }}@enderror" id="blood_type" name="blood_type" placeholder="Type Firstname..." value="{{ old('blood_type') }}">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select class="custom-select  @error('is_disabled') {{ 'is-invalid' }}@enderror"
                                    ...
                                    <option value="0" {{ old('is_disabled') == '0' ? 'selected' : ''}}>No</option>
                                </select>
